...
if(isset($_POST['submit'])){
    ...
    if($count>0){
        ...
        $Err = 'No user found kindly check your username and password!';
    }
}
?>
...
<!--Sign Up form section start from here-->
<section class="text-gray-600 body-font">
<form method="post">
  <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
    <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
      <h1 class="title-font font-medium text-3xl text-gray-900">Welcome Back To ShutLy.cf</h1>
      <p class="leading-relaxed mt-4">Wow welcome back use your login details in order to login your ShutLy.cf account we are waiting bro/sis.</p>
    </div>
    <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      ...
      <button type="submit" name="submit" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Login Now</button>
      <p class="text-xs text-red-500 mt-3"><?php echo $Err ?></p>
    </div>
  </div>
  </form>
</section>
<!--Sign Up form section end here-->
